...
import ContactForm from "@/app/Components/Shared/ContactFrom/ContactFrom";
      ...
      <div className="main_container">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
          ...
          <div className="contact_content w-full">
            ...
            Get in touch to schedule a visit to your new Product.
            </h2>
            <div className="border-b-2 py-2 md:py-4">
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing? Explore
                opportunities with{" "}
            ...
            <div className="flex flex-col gap-2 md:gap-3 mb-2">
              <div className="flex items-center gap-2 md:gap-4">
                ...
                <p>
                  Call : <span className="font-semibold">+234905 121 8127</span>
                </p>
              </div>
              <div className="flex items-center gap-2">
                ...
                <p>
                  WhatsApp : <span className="font-semibold">8269900555</span>
                </p>
              </div>
              <div className="flex items-center gap-2">
                <p className="p-2 md:p-3 shadow  bg-[#D3E5F0] text-md md:text-xl rounded text-black">
