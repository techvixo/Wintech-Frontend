...
// Import your images
import img1 from "@@/home-img/machine/1.png";
import img2 from "@@/home-img/machine/2.png";
import img3 from "@@/home-img/machine/3.png";
import img4 from "@@/home-img/machine/2.png"; // Reusing img2
     ...
     <div className="main_container relative">
      ...
      <Slider {...settings}>
        {machineParts.map((part, i) => {
          return <MachineCard key={part.id} part={part}></MachineCard>;
        })}
      </Slider>
    </div>
   </div>
